...
add_para('官方网站：https://www.clipopai.com', size=12)
add_para('桌面客户端：Clipop Agent（macOS，Apple Silicon）', size=12)
add_para('当前版本：v0.9.30', size=12)
...
add_bullet('用户访问 www.clipopai.com')
...
add_para('官方网站：https://www.clipopai.com', size=12)
add_para('下载页面：https://www.clipopai.com/download', size=12)
add_para('定价页面：https://www.clipopai.com/pricing', size=12)
add_para('博客页面：https://www.clipopai.com/blog', size=12)
add_para('GitHub 仓库：https://github.com/Aiven66/vidshorter-ai', size=12)
add_para('桌面客户端下载：https://github.com/Aiven66/vidshorter-ai/releases/tag/v0.9.30', size=12)
