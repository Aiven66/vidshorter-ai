#!/usr/bin/env node
/**
 * Setup behavior_events table via Supabase Management API.
 * Uses a Personal Access Token (PAT) to execute DDL SQL.
 *
 * Usage:
 *   SUPABASE_ACCESS_TOKEN=sbp_xxx node scripts/setup-behavior-events.js
 */
const fs = require('fs');
...
const SQL_FILE = path.join(__dirname, 'setup-behavior-events.sql');
