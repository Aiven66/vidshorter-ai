...
本 Worker 从 Cloudflare IP 调用 YouTube InnerTube API，绕过 YouTube 对 AWS/Vercel 数据中心 IP 的封锁。
...
```bash
curl "https://youtube-proxy.<your-subdomain>.workers.dev?videoId=dQw4w9WgXcQ"
```
