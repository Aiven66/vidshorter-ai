...
export function GoogleLoginButton({ className = '', size = 'default' }: GoogleLoginButtonProps) {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      console.error('[GOOGLE-BUTTON] Google login exception:', error);
  ...
  return (
    <div className="space-y-2">
      <Button
        variant="outline"
        className={`w-full h-11 text-base border-gray-300 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-900 ${className}`}
        size={size}
