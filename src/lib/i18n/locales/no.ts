...
const translations = {
  ...commonTranslations,
  nav: {
  home: 'Hjem', blog: 'Blogg', pricing: 'Priser', about: 'Om oss', login: 'Logg inn', register: 'Registrer', dashboard: 'Dashboard', admin: 'Admin Panel', logout: 'Logg ut', credits: 'Kreditter', download: 'Last Ned App', light: 'Lys', dark: 'Mørk',
  },
  footer: {
  ...
  paymentNote: 'Creem is available now · PayPal checkout is prepared and pending approval', secureNote: 'Alle betalinger sikret med TLS 256-bit kryptering', faqTitle: 'Ofte Stilte Spørsmål', faq: { q1: 'Hva er en kreditt?', a1: 'Hver kreditt representerer behandlingskraft. Behandling av et videoklipp koster 60 kreditter.', q2: 'Hvordan fungerer daglig kreditt-nullstilling?', a2: 'Kreditter nullstilles til planens daglige grense kl. 00:00 UTC hver dag. Ubrukte kreditter overføres ikke.', q3: 'Kan jeg oppgradere eller nedgradere planen min?', a3: 'Ja, du kan endre planen din når som helst. Endringer trer i kraft umiddelbart.', q4: 'Hvilke videokilder støttes?', a4: 'Vi støtter YouTube, Bilibili og direkte videofil-opplasting (MP4, MOV, AVI).', q5: 'Hvilke betalingsmetoder støttes?', a5: 'Creem is available now for cards, Apple Pay, and Google Pay. PayPal checkout is prepared and will be enabled after approval.' },
