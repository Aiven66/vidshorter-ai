...
const translations = {
  ...commonTranslations,
  nav: {
  home: 'หน้าแรก', blog: 'บล็อก', pricing: 'ราคา', about: 'เกี่ยวกับเรา', login: 'เข้าสู่ระบบ', register: 'สมัคร', dashboard: 'แดชบอร์ด', admin: 'แผงควบคุมผู้ดูแล', logout: 'ออกจากระบบ', credits: 'เครดิต', download: 'ดาวน์โหลดแอป', light: 'สว่าง', dark: 'มืด',
  },
  common: {
  ...
  paymentNote: 'Creem is available now · PayPal checkout is prepared and pending approval', secureNote: 'การชำระเงินทั้งหมดปลอดภัยด้วยการเข้ารหัส TLS 256 บิต', faqTitle: 'คำถามที่พบบ่อย', faq: { q1: 'เครดิตคืออะไร?', a1: 'เครดิตแต่ละหน่วยแทนพลังการประมวลผล การประมวลผลคลิปวิดีโอหนึ่งคลิปใช้ 60 เครดิต', q2: 'การรีเซ็ตเครดิตรายวันทำงานอย่างไร?', a2: 'เครดิตจะรีเซ็ตเป็นขีดจำกัดรายวันตามแผนของคุณเวลา 00:00 UTC ทุกวัน เครดิตที่ไม่ได้ใช้จะไม่สะสม', q3: 'ฉันสามารถอัปเกรดหรือดาวน์เกรดแผนได้หรือไม่?', a3: 'ได้ คุณสามารถเปลี่ยนแผนได้ตลอดเวลา การเปลี่ยนแปลงมีผลทันที', q4: 'รองรับแหล่งวิดีโอใดบ้าง?', a4: 'รองรับ YouTube, Bilibili และอัปโหลดไฟล์วิดีโอโดยตรง (MP4, MOV, AVI)', q5: 'รองรับวิธีชำระเงินใดบ้าง?', a5: 'Creem is available now for cards, Apple Pay, and Google Pay. PayPal checkout is prepared and will be enabled after approval.' },
  mostPopular: 'ยอดนิยม',
