...
const translations = {
  ...commonTranslations,
  nav: {
  home: 'Hjem', blog: 'Blog', pricing: 'Priser', about: 'Om os', login: 'Log ind', register: 'Opret', dashboard: 'Dashboard', admin: 'Admin Panel', logout: 'Log ud', credits: 'Krediter', download: 'Download App', light: 'Lyst', dark: 'Mørkt',
  },
  footer: {
  ...
  paymentNote: 'Creem is available now · PayPal checkout is prepared and pending approval', secureNote: 'Alle betalinger sikret med TLS 256-bit kryptering', faqTitle: 'Ofte Stillede Spørgsmål', faq: { q1: 'Hvad er en kredit?', a1: 'Hver kredit repræsenterer behandlingskraft. Behandling af et videoklip koster 60 kreditter.', q2: 'Hvordan fungerer daglig kredit-nulstilling?', a2: 'Kreditter nulstilles til din plans daglige grænse kl. 00:00 UTC hver dag. Ubrugte kreditter overføres ikke.', q3: 'Kan jeg opgradere eller nedgradere min plan?', a3: 'Ja, du kan ændre din plan når som helst. Ændringer træder i kraft straks.', q4: 'Hvilke videokilder understøttes?', a4: 'Vi understøtter YouTube, Bilibili og direkte videofil-upload (MP4, MOV, AVI).', q5: 'Hvilke betalingsmetoder understøttes?', a5: 'Creem is available now for cards, Apple Pay, and Google Pay. PayPal checkout is prepared and will be enabled after approval.' },
