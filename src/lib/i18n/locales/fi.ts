...
const translations = {
  ...
  paymentNote: 'Creem is available now · PayPal checkout is prepared and pending approval', secureNote: 'Kaikki maksut suojattu TLS 256-bit salauksella', faqTitle: 'Usein Kysytyt Kysymykset', faq: { q1: 'Mikä on krediitti?', a1: 'Jokainen krediitti edustaa käsittelytehoa. Videoklipin käsittely maksaa 60 krediittiä.', q2: 'Miten päivittäinen krediittien nollaus toimii?', a2: 'Krediitit nollataan suunnitelmasi päivittäiseen rajaan joka päivä klo 00:00 UTC. Käyttämättömät krediitit eivät siirry.', q3: 'Voinko päivittää tai alentaa suunnitelmaani?', a3: 'Kyllä, voit vaihtaa suunnitelmaa milloin tahansa. Muutokset astuvat voimaan heti.', q4: 'Mitä videolähteitä tuetaan?', a4: 'Tuemme YouTubea, Bilibiliä ja suoria videotiedostojen latauksia (MP4, MOV, AVI).', q5: 'Mitä maksutapoja tuetaan?', a5: 'Creem is available now for cards, Apple Pay, and Google Pay. PayPal checkout is prepared and will be enabled after approval.' },
