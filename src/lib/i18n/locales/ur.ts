...
const translations = {
  ...commonTranslations,
  nav: {
  home: 'ہوم', blog: 'بلاگ', pricing: 'قیمتیں', about: 'ہمارے بارے میں', login: 'لاگ ان', register: 'رجسٹر', dashboard: 'ڈیش بورڈ', admin: 'ایڈمن پینل', logout: 'لاگ آؤٹ', credits: 'کریڈٹس', download: 'ایپ ڈاؤن لوڈ کریں', light: 'لائٹ', dark: 'ڈارک',
  },
  common: {
  ...
  paymentNote: 'Creem is available now · PayPal checkout is prepared and pending approval', secureNote: 'تمام ادائیگیاں TLS 256-bit انکرپشن سے محفوظ', faqTitle: 'اکثر پوچھے گئے سوالات', faq: { q1: 'کریڈٹ کیا ہے؟', a1: 'ہر کریڈٹ پروسیسنگ پاور کی نمائندگی کرتا ہے۔ ایک ویڈیو کلپ پروسیس کرنے میں 60 کریڈٹس لگتے ہیں۔', q2: 'روزانہ کریڈٹ ری سیٹ کیسے کام کرتا ہے؟', a2: 'کریڈٹس ہر روز 00:00 UTC پر آپ کے پلان کی روزانہ حد تک ری سیٹ ہو جاتے ہیں۔ غیر استعمال شدہ کریڈٹس منتقل نہیں ہوتے۔', q3: 'کیا میں اپنا پلان اپ گریڈ یا ڈاؤن گریڈ کر سکتا ہوں؟', a3: 'ہاں، آپ کسی بھی وقت اپنا پلان تبدیل کر سکتے ہیں۔ تبدیلیاں فوری طور پر لاگو ہوتی ہیں۔', q4: 'کون سے ویڈیو ذرائع تعاون یافتہ ہیں؟', a4: 'ہم YouTube، Bilibili اور براہ راست ویڈیو فائل اپ لوڈ (MP4, MOV, AVI) کی حمایت کرتے ہیں۔', q5: 'کون سے ادائیگی کے طریقے تعاون یافتہ ہیں؟', a5: 'Creem is available now for cards, Apple Pay, and Google Pay. PayPal checkout is prepared and will be enabled after approval.' },
