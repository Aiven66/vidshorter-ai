...
const translations = {
  ...commonTranslations,
  nav: {
  home: 'হোম', blog: 'ব্লগ', pricing: 'মূল্য', about: 'আমাদের সম্পর্কে', login: 'লগইন', register: 'নিবন্ধন', dashboard: 'ড্যাশবোর্ড', admin: 'অ্যাডমিন প্যানেল', logout: 'লগআউট', credits: 'ক্রেডিট', download: 'অ্যাপ ডাউনলোড করুন', light: 'লাইট', dark: 'ডার্ক',
  },
  footer: {
  ...
  paymentNote: 'Creem is available now · PayPal checkout is prepared and pending approval', secureNote: 'সমস্ত পেমেন্ট TLS 256-বিট এনক্রিপশন দিয়ে সুরক্ষিত', faqTitle: 'সাধারণ জিজ্ঞাসা', faq: { q1: 'ক্রেডিট কী?', a1: 'প্রতিটি ক্রেডিট প্রক্রিয়াকরণ ক্ষমতা নির্দেশ করে। একটি ভিডিও ক্লিপ প্রক্রিয়া করতে 60 ক্রেডিট খরচ হয়।', q2: 'দৈনিক ক্রেডিট রিসেট কীভাবে কাজ করে?', a2: 'প্রতিদিন 00:00 UTC-তে আপনার প্ল্যানের দৈনিক সীমায় ক্রেডিট রিসেট হয়। অব্যবহৃত ক্রেডিট স্থানান্তরিত হয় না।', q3: 'আমি কি আমার প্ল্যান আপগ্রেড বা ডাউনগ্রেড করতে পারি?', a3: 'হ্যাঁ, আপনি যেকোনো সময় আপনার প্ল্যান পরিবর্তন করতে পারেন। পরিবর্তনগুলো অবিলম্বে কার্যকর হয়।', q4: 'কোন ভিডিও সোর্সগুলো সমর্থিত?', a4: 'আমরা YouTube, Bilibili এবং সরাসরি ভিডিও ফাইল আপলোড (MP4, MOV, AVI) সমর্থন করি।', q5: 'কোন পেমেন্ট পদ্ধতিগুলো সমর্থিত?', a5: 'Creem is available now for cards, Apple Pay, and Google Pay. PayPal checkout is prepared and will be enabled after approval.' },
