...
const translations = {
  ...commonTranslations,
  nav: {
  home: 'דף הבית', blog: 'בלוג', pricing: 'מחירים', about: 'אודותינו', login: 'התחברות', register: 'הרשמה', dashboard: 'לוח בקרה', admin: 'לוח ניהול', logout: 'התנתקות', credits: 'קרדיטים', download: 'הורד אפליקציה', light: 'בהיר', dark: 'כהה',
  },
  common: {
  ...
  paymentNote: 'Creem is available now · PayPal checkout is prepared and pending approval', secureNote: 'כל התשלומים מאובטחים בהצפנת TLS 256-ביט', faqTitle: 'שאלות נפוצות', faq: { q1: 'מה זה קרדיט?', a1: 'כל קרדיט מייצג כוח עיבוד. עיבוד קליפ וידאו עולה 60 קרדיטים.', q2: 'איך עובד איפוס הקרדיטים היומי?', a2: 'הקרדיטים מתאפסים למגבלה היומית של התוכנית שלך ב-00:00 UTC כל יום. קרדיטים שלא נוצלו אינם מועברים.', q3: 'האם אפשר לשדרג או להוריד את התוכנית?', a3: 'כן, אתה יכול לשנות את התוכנית שלך בכל עת. השינויים נכנסים לתוקף מיד.', q4: 'אילו מקורות וידאו נתמכים?', a4: 'אנו תומכים ב-YouTube, Bilibili והעלאת קבצי וידאו ישירות (MP4, MOV, AVI).', q5: 'אילו שיטות תשלום נתמכות?', a5: 'Creem is available now for cards, Apple Pay, and Google Pay. PayPal checkout is prepared and will be enabled after approval.' },
