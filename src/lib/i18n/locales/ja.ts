...
const translations = {
  ...
  paymentNote: 'Creem is available now · PayPal checkout is prepared and pending approval', secureNote: 'すべての支払いはTLS 256ビット暗号化で保護されています', faqTitle: 'よくある質問', faq: { q1: 'クレジットとは何ですか？', a1: '各クレジットは処理能力を表します。動画クリップの処理には60クレジットが必要です。', q2: '毎日のクレジットリセットはどのように機能しますか？', a2: 'クレジットは毎日00:00 UTCにプランの日次上限にリセットされます。未使用のクレジットは繰り越されません。', q3: 'プランをアップグレードまたはダウングレードできますか？', a3: 'はい、いつでもプランを変更できます。変更は即座に反映されます。', q4: 'どの動画ソースがサポートされていますか？', a4: 'YouTube、Bilibili、および直接動画ファイルのアップロード（MP4, MOV, AVI）をサポートしています。', q5: 'どの支払い方法がサポートされていますか？', a5: 'Creem is available now for cards, Apple Pay, and Google Pay. PayPal checkout is prepared and will be enabled after approval.' },
  mostPopular: '最も人気',
