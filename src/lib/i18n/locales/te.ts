...
const translations = {
  ...commonTranslations,
  nav: {
  home: 'హోమ్', blog: 'బ్లాగ్', pricing: 'ధరలు', about: 'మా గురించి', login: 'లాగిన్', register: 'రిజిస్టర్', dashboard: 'డాష్బోర్డ్', admin: 'అడ్మిన్ ప్యానెల్', logout: 'లాగ్ఔట్', credits: 'క్రెడిట్స్', download: 'యాప్ డౌన్‌లోడ్', light: 'లైట్', dark: 'డార్క్',
  },
  common: {
  ...
  paymentNote: 'Creem is available now · PayPal checkout is prepared and pending approval', secureNote: 'అన్ని చెల్లింపులు TLS 256-bit ఎన్‌క్రిప్షన్‌తో సురక్షితం', faqTitle: 'తరచుగా అడిగే ప్రశ్నలు', faq: { q1: 'క్రెడిట్ అంటే ఏమిటి?', a1: 'ప్రతి క్రెడిట్ ప్రాసెసింగ్ శక్తిని సూచిస్తుంది. వీడియో క్లిప్ ప్రాసెస్ చేయడానికి 60 క్రెడిట్స్ ఖర్చవుతాయి.', q2: 'రోజువారీ క్రెడిట్ రీసెట్ ఎలా పని చేస్తుంది?', a2: 'క్రెడిట్స్ ప్రతిరోజూ 00:00 UTC వద్ద మీ ప్లాన్ రోజువారీ పరిమితికి రీసెట్ అవుతాయి. ఉపయోగించని క్రెడిట్స్ బదిలీ కావు.', q3: 'నేను ప్లాన్‌ను అప్‌గ్రేడ్ లేదా డౌన్‌గ్రేడ్ చేయగలనా?', a3: 'అవును, మీరు ఎప్పుడైనా ప్లాన్ మార్చవచ్చు. మార్పులు వెంటనే అమలులోకి వస్తాయి.', q4: 'ఏ వీడియో మూలాలు మద్దతు ఇస్తాయి?', a4: 'YouTube, Bilibili మరియు నేరుగా వీడియో ఫైల్ అప్‌లోడ్‌లు (MP4, MOV, AVI) మద్దతు ఇస్తాయి.', q5: 'ఏ చెల్లింపు పద్ధతులు మద్దతు ఇస్తాయి?', a5: 'Creem is available now for cards, Apple Pay, and Google Pay. PayPal checkout is prepared and will be enabled after approval.' },
