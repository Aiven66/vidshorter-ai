...
const translations = {
  ...commonTranslations,
  nav: {
  home: 'Laman Utama', blog: 'Blog', pricing: 'Harga', about: 'Tentang kami', login: 'Log Masuk', register: 'Daftar', dashboard: 'Papan Pemuka', admin: 'Panel Admin', logout: 'Log Keluar', credits: 'Kredit', download: 'Muat Turun Aplikasi', light: 'Cerah', dark: 'Gelap',
  },
  footer: {
  ...
  errorNameRequired: 'Sila masukkan nama anda', errorEmailRequired: 'Sila masukkan e-mel anda', errorPasswordLength: 'Kata laluan mestilah sekurang-kurangnya 6 aksara', errorPasswordMismatch: 'Kata laluan tidak sepadan', errorEmailExists: 'E-mel ini sudah didaftarkan. Sila log masuk sebaliknya.', errorSendCode: 'Gagal menghantar kod', errorNetwork: 'Ralat rangkaian. Sila cuba lagi.', errorCodeLength: 'Sila masukkan kod 6 digit',
    agreeTerms: 'Saya bersetuju dengan {terms} dan {privacy}', termsLink: 'Terma Perkhidmatan', privacyLink: 'Dasar Privasi', errorAgreeTerms: 'Anda mesti bersetuju dengan Terma Perkhidmatan dan Dasar Privasi',
