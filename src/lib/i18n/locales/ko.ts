...
const translations = {
  ...commonTranslations,
  nav: {
  home: '홈', blog: '블로그', pricing: '가격', about: '회사 소개', login: '로그인', register: '회원가입', dashboard: '대시보드', admin: '관리자 패널', logout: '로그아웃', credits: '크레딧', download: '앱 다운로드', light: '라이트', dark: '다크',
  },
  footer: {
...
,
{
    about: {
      ...
      features: {
        ...
        aiIntelligence: {
          title: AI驅動 지능,
          desc: 고급 AI 알고리즘이 영상 콘텐츠를 자동으로 분석하여 가장 매력적인 순간을 식별하여 창작자의 수동 편집 시간을 수 시간 절약합니다.
        },
        fastProcessing: {
          title: 초고속 처리,
          desc: 긴 영상을 몇 분 만에 처리합니다. 최적화된 파이프라인이 하이라이트를 즉시 제공합니다.
        },
        multiPlatform: {
          title: 멀티 플랫폼 지원,
          desc: YouTube, Bilibili에서 가져오거나 로컬 파일을 업로드합니다. TikTok, YouTube Shorts, Instagram 등을 위한 최적화된 클립을 내보냅니다.
        },
        privacyFirst: {
          title: 개인정보 보호 우선,
          desc: 귀하의 콘텐츠는 귀하만의 것입니다. 당사는 원본 영상을 저장하지 않으며 모든 것을 안전하게 처리합니다.
        }
      },
      values: {
        title: 우리의 핵심 가치,
        ...
        userCentric: {
          title: 사용자 중심 혁신,
          desc: 전 세계 콘텐츠 창작자의 실제 문제를 해결하는 도구를 구축합니다.
        },
        continuous: {
          title: 지속적인 개선,
          desc: 사용자 피드백에 기반한 정기적인 업데이트로 경험을 향상시킵니다.
        },
        community: {
          title: 글로벌 커뮤니티,
          desc: 전 세계 6개 대륙에서 32개 언어를 지원하는 창작자 지원.
        }
      },
      geo: {
        title: 글로벌 리치, 로컬 임팩트,
