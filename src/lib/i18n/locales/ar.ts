...
const translations = {
  ...
  paymentNote: 'Creem is available now · PayPal checkout is prepared and pending approval', secureNote: 'جميع المدفوعات مؤمنة بتشفير TLS 256 بت', faqTitle: 'الأسئلة الشائعة', faq: { q1: 'ما هو الرصيد؟', a1: 'يمثل كل رصيد قوة معالجة. معالجة مقطع فيديو تكلف 60 رصيدًا.', q2: 'كيف يعمل إعادة تعيين الأرصدة اليومية؟', a2: 'تتم إعادة تعيين الأرصدة إلى الحد اليومي لخطتك في 00:00 UTC كل يوم. الأرصدة غير المستخدمة لا تُنقل.', q3: 'هل يمكنني ترقية أو تخفيض خطتي؟', a3: 'نعم، يمكنك تغيير خطتك في أي وقت. تسري التغييرات فورًا.', q4: 'ما هي مصادر الفيديو المدعومة؟', a4: 'ندعم YouTube وBilibili ورفع ملفات الفيديو مباشرة (MP4, MOV, AVI).', q5: 'ما هي طرق الدفع المدعومة؟', a5: 'Creem is available now for cards, Apple Pay, and Google Pay. PayPal checkout is prepared and will be enabled after approval.' },
  ...
  errorNameRequired: 'يرجى إدخال اسمك', errorEmailRequired: 'يرجى إدخال بريدك الإلكتروني', errorPasswordLength: 'يجب أن تكون كلمة المرور 6 أحرف على الأقل', errorPasswordMismatch: 'كلمات المرور غير متطابقة', errorEmailExists: 'هذا البريد الإلكتروني مسجل بالفعل. يرجى تسجيل الدخول بدلاً من ذلك.', errorSendCode: 'فشل إرسال الرمز', errorNetwork: 'خطأ في الشبكة. يرجى المحاولة مرة أخرى.', errorCodeLength: 'يرجى إدخال رمز من 6 أرقام',
    agreeTerms: 'أوافق على {terms} و{privacy}',   termsLink: 'شروط الخدمة',   privacyLink: 'سياسة الخصوصية',   errorAgreeTerms: 'يجب عليك الموافقة على شروط الخدمة وسياسة الخصوصية',
