...
const translations = {
  ...commonTranslations,
  nav: {
  home: 'मुख्यपृष्ठ', blog: 'ब्लॉग', pricing: 'किंमती', about: 'आमच्याबद्दल', login: 'लॉगिन', register: 'नोंदणी', dashboard: 'डॅशबोर्ड', admin: 'अॅडमिन पॅनेल', logout: 'लॉगआउट', credits: 'क्रेडिटस', download: 'अॅप डाउनलोड करा', light: 'लाइट', dark: 'डार्क',
  },
  common: {
  ...
  paymentNote: 'Creem is available now · PayPal checkout is prepared and pending approval', secureNote: 'सर्व पेमेंट TLS 256-bit एन्क्रिप्शनने सुरक्षित', faqTitle: 'वारंवार विचारले जाणारे प्रश्न', faq: { q1: 'क्रेडिट म्हणजे काय?', a1: 'प्रत्येक क्रेडिट प्रक्रिया शक्ती दर्शवतो. व्हिडिओ क्लिप प्रक्रिया करण्यासाठी 60 क्रेडिट्स लागतात.', q2: 'दैनिक क्रेडिट रीसेट कसे काम करते?', a2: 'क्रेडिट्स दररोज 00:00 UTC वर तुमच्या योजनेच्या दैनिक मर्यादेपर्यंत रीसेट होतात. न वापरलेले क्रेडिट्स स्थानांतरित होत नाहीत.', q3: 'मी योजना अपग्रेड किंवा डाउनग्रेड करू शकतो का?', a3: 'होय, तुम्ही कोणत्याही वेळी योजना बदलू शकता. बदल तात्काळ प्रभावी होतात.', q4: 'कोणते व्हिडिओ स्रोत समर्थित आहेत?', a4: 'आम्ही YouTube, Bilibili आणि थेट व्हिडिओ फाईल अपलोड (MP4, MOV, AVI) समर्थन करतो.', q5: 'कोणत्या पेमेंट पद्धती समर्थित आहेत?', a5: 'Creem is available now for cards, Apple Pay, and Google Pay. PayPal checkout is prepared and will be enabled after approval.' },
