...
const translations = {
  ...
  paymentNote: 'Creem is available now · PayPal checkout is prepared and pending approval', secureNote: 'Tất cả thanh toán được bảo mật bằng mã hóa TLS 256-bit', faqTitle: 'Câu Hỏi Thường Gặp', faq: { q1: 'Tín dụng là gì?', a1: 'Mỗi tín dụng đại diện cho năng lực xử lý. Xử lý một clip video tiêu tốn 60 tín dụng.', q2: 'Cách đặt lại tín dụng hàng ngày hoạt động như thế nào?', a2: 'Tín dụng được đặt lại về giới hạn hàng ngày của gói lúc 00:00 UTC mỗi ngày. Tín dụng không sử dụng không được chuyển sang.', q3: 'Tôi có thể nâng cấp hoặc hạ cấp gói không?', a3: 'Có, bạn có thể thay đổi gói bất cứ lúc nào. Thay đổi có hiệu lực ngay lập tức.', q4: 'Nguồn video nào được hỗ trợ?', a4: 'Chúng tôi hỗ trợ YouTube, Bilibili và tải lên tệp video trực tiếp (MP4, MOV, AVI).', q5: 'Phương thức thanh toán nào được hỗ trợ?', a5: 'Creem is available now for cards, Apple Pay, and Google Pay. PayPal checkout is prepared and will be enabled after approval.' },
