...
export const commonTranslations = {
  ...
  referral: {
    ...
    subtitle: 'Share your invite link. When a friend registers via the link, both of you get 100 credits!',
    inviteLinkLabel: 'Your Invite Link',
    copyLink: 'Copy Link',
    copied: 'Copied!',
    copyFailed: 'Copy failed, please long-press the link to copy manually.',
    statsLabel: 'Successful Invites',
    friendsUnit: 'friends',
    rewardPerInvite: 'Reward per invite',
    creditsUnit: 'credits',
    shareLabel: 'Or share via',
    loadingLink: 'Loading invite link...',
    loadFailed: 'Failed to load invite link. Please retry.',
    refresh: 'Refresh',
  ...
  video: {
    ...
    recording: 'Recording...',
    recordAllowCapture: 'Please allow screen capture and select this tab to record the clip',
    recordPlaying: 'Recording clip ({duration}s)...',
    recordComplete: 'Recording complete! You can now download the MP4.',
    recordFailed: 'Recording failed',
    recordPermissionDenied: 'Screen capture permission denied. Cannot record clip.',
    recordHint: 'Tip: Click "Record MP4" to capture this clip as a downloadable video. Select "Share this tab" when prompted for best quality.',
    stage: {
      init: 'Initializing...',
...
export const translations: Record<Locale, Record<string, string>> = {
  ...
  zh: flattenTranslations({
    ...
    referral: {
      title: '邀请好友，赚取积分',
      subtitle: '分享你的邀请链接，好友通过链接注册，你和朋友各得 100 积分！',
      ...
      creditsUnit: '积分',
      shareLabel: '或通过以下方式分享',
      loadingLink: '邀请链接加载中...',
      loadFailed: '加载邀请链接失败，请重试。',
      refresh: '刷新',
  ...
  'zh-Hant': flattenTranslations({
    ...
    referral: {
      title: '邀請好友，賺取積分',
      subtitle: '分享你的邀請連結，好友透過連結註冊，你和朋友各得 100 積分！',
      inviteLinkLabel: '你的邀請連結',
      copyLink: '複製連結',
      copied: '已複製！',
      copyFailed: '複製失敗，請長按連結手動複製。',
      statsLabel: '成功邀請',
      friendsUnit: '位好友',
      rewardPerInvite: '每次邀請獎勵',
      creditsUnit: '積分',
      shareLabel: '或透過以下方式分享',
      loadingLink: '邀請連結載入中...',
      loadFailed: '載入邀請連結失敗，請重試。',
      refresh: '重新整理',
  ...
  pt: flattenTranslations({
    ...
    video: {
      ...
      creditsAvailable: 'créditos disponíveis', signInToStart: 'para começar a processar vídeos', pasteUrlPlaceholder: 'Cole uma URL de vídeo (MP4, MOV, AVI...)', useLocalAgent: 'Usar agente local Mac (recomendado para YouTube estável)', uploadLocal: 'Fazer upload de um arquivo de vídeo local (recomendado quando o link do YouTube está bloqueado)', selectedFile: 'Selecionado', downloadMacApp: 'Baixar App Mac', viewPricing: 'Ver Preços', clipsReady: 'clips prontos', playableClips: 'clips reproduzíveis', failedClips: 'falharam', aiFinished: 'A IA terminou de selecionar os momentos mais fortes do seu vídeo fonte.', openToPreview: 'Abra qualquer clip pronto para pré-visualizar, ou baixe o MP4 diretamente.', clipsBeingGenerated: 'Clips sendo gerados:', videoPreviewNotAvailable: 'Pré-visualização do vídeo não disponível', clipMayStillProcessing: 'O clip pode ainda estar processando ou a geração falhou.', insufficientCredits: 'Créditos insuficientes. Você precisa de pelo menos 60 créditos.', enterVideoUrl: 'Por favor insira uma URL de vídeo ou faça upload de um arquivo de vídeo local.', enterValidUrl: 'Por favor insira uma URL de vídeo http(s) pública válida.',
      stage: {
  ...
  bn: flattenTranslations({
    ...
    pricing: {
      ...
      paymentNote: 'চীনের জন্য Alipay · আন্তর্জাতিকের জন্য Creem (Visa / Mastercard / Apple Pay / Google Pay)', secureNote: 'সমস্ত পেমেন্ট TLS 256-বিট এনক্রিপশন দিয়ে সুরক্ষিত', faqTitle: 'সাধারণ জিজ্ঞাসা', faq: { q1: 'ক্রেডিট কী?', a1: 'প্রতিটি ক্রেডিট প্রক্রিয়াকরণ ক্ষমতা নির্দেশ করে। একটি ভিডিও ক্লিপ প্রক্রিয়া করতে 60 ক্রেডিট খরচ হয়।', q2: 'দৈনিক ক্রেডিট রিসেট কীভাবে কাজ করে?', a2: 'প্রতিদিন 00:00 UTC-তে আপনার প্ল্যানের দৈনিক সীমায় ক্রেডিট রিসেট হয়। অব্যবহৃত ক্রেডিট স্থানান্তরিত হয় না।', q3: 'আমি কি আমার প্ল্যান আপগ্রেড বা ডাউনগ্রেড করতে পারি?', a3: 'হ্যাঁ, আপনি যেকোনো সময় আপনার প্ল্যান পরিবর্তন করতে পারেন। পরিবর্তনগুলো অবিলম্বে কার্যকর হয়।', q4: 'কোন ভিডিও সোর্সগুলো সমর্থিত?', a4: 'আমরা YouTube, Bilibili এবং সরাসরি ভিডিও ফাইল আপলোড (MP4, MOV, AVI) সমর্থন করি।', q5: 'কোন পেমেন্ট পদ্ধতিগুলো সমর্থিত?', a5: 'চীন ব্যবহারকারীদের জন্য Alipay, আন্তর্জাতিক ব্যবহারকারীদের জন্য Creem (Visa, Mastercard, Apple Pay, Google Pay)।' },
